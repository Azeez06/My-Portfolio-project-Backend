...
import AshBox from "@/components/AshBox"; // ← adjust if your folder differs
      ...
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => (
            <AshBox key={index} delay={index * 400}>
              <div className="bg-[#111827] p-6 rounded-xl shadow-lg border border-gray-700 hover:border-blue-500 hover:shadow-blue-500/20 transition-all duration-300 cursor-pointer">
